# Metrica — angular-metrica-bi

> Semana(s): 4 · Pilar: **Dashboard** · Teste unitário: **Vitest** · Milestone(s): `m1-metrica`
> Repo público: [github.com/zecki1/angular-metrica-bi](https://github.com/zecki1/angular-metrica-bi)

## Objetivo de entrevista

entregar painel administrativo corporativo: KPIs, roles/permissões, lazy loading e tabelas complexas
...
Dados usados: profiles (admin/analyst)
